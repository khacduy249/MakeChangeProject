...
public class test {
	public static void main(String[] args) {
        ...
        System.out.println("Number of Quarter coin: " + quarters);
        System.out.println("Number of Dime coin: " + dimes);
        System.out.println("Number of Nickel coin: " + nickels);
        System.out.println("Number of Pennies coin: " + pennies);
    }
}